...
void receive_network_topology_over_UDP() {
    ...
    for (; ;) {
        if (recvfrom(UDP_socket_descriptor, buffer, UDP_MESSAGE_LENGTH, 0, (struct sockaddr *) &UDP_socket_address,
